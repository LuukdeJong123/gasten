...
def main():
    ...
    scenario = Scenario(configspace, objectives=objectives, deterministic=True, walltime_limit=288000, n_trials=10000)
    ...
    with open(f'{os.environ["FILESDIR"]}/step-2-bayesian-best-config-{args.dataset}-{pos_class}v{neg_class}.txt', 'w') as file:
