...
def main():
    ...
    scenario = Scenario(configspace, deterministic=True, min_budget=2, max_budget=10, walltime_limit=3600)
    ...
    with open(f'{os.environ["FILESDIR"]}/step-1-best-config-{pos_class}v{neg_class}.txt', 'w') as file:
