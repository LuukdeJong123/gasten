...
def main():
    ...
    scenario = Scenario(configspace, deterministic=True, min_budget=2, max_budget=10, n_trials=500, walltime_limit=72000)
    intensifier = Hyperband(scenario, eta=2)
    smac = HyperbandFacade(scenario, train, intensifier=intensifier, overwrite=True)
